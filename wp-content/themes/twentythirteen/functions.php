...
add_action('wp_insert_post', 'wpc_champs_personnalises_defaut');
 ...
 {
 if ( $_GET['post_type']  ) {
 add_post_meta($post_id, 'nom établissement', '', true);
 add_post_meta($post_id, 'adresse', '', true);
 add_post_meta($post_id, 'Google map', '', true);
 add_post_meta($post_id, 'téléphone', '', true);
 add_post_meta($post_id, 'horaire ouverture', '', true);
 add_post_meta($post_id, 'image_une', '', true);
 }
 return true;
 }
...
// Remove categories from wordpress feed
