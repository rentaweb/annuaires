...
function wpgmza_pro_return_category_checkbox_list($map_id) {
    global $wpdb;
    global $wpgmza_tblname_categories;
    global $wpgmza_tblname_category_maps;
    ...
    $sql = "SELECT * FROM `$wpgmza_tblname_category_maps` WHERE `map_id` = '$map_id' OR `map_id` = '0'";
        ...
        $ret_msg .= "<div style='display:block; float:left;'><input type='checkbox' class='wpgmza_checkbox' name='wpgmza_cat_checkbox' mid=\"".$map_id."\" value=\"0\" />".__("All","wp-google-maps")."</div>";
    ...
    foreach ( $results as $result ) {
        ...
        $results = $wpdb->get_results("
            ...
            ");
        foreach ( $results as $result ) {
            $ret_msg .= "<div style='display:block; float:left; margin-left:5px;'><input type='checkbox' class='wpgmza_checkbox' name='wpgmza_cat_checkbox' mid=\"".$map_id."\" value=\"".$result->id."\" />".$result->category_name."</div>";
        }
