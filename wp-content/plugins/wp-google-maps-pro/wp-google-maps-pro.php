...
function wpgmza_pro_menu() {
    ...
    if ($_GET['action'] == "edit") {
        ...
        $data['map_default_starting_lat'] = $def_data->map_default_starting_lat;
        $data['map_default_starting_lng'] = $def_data->map_default_starting_lng;
        $data['map_default_height'] = $def_data->map_default_height;
        $data['map_default_width'] = $def_data->map_default_width;
        $data['map_default_height_type'] = stripslashes($def_data->map_default_height_type);
        $data['map_default_width_type'] =stripslashes($def_data->map_default_width_type);
        $data['map_default_zoom'] = $def_data->map_default_zoom;
        $data['map_default_type'] = $def_data->map_default_type;
        $data['map_default_alignment'] = $def_data->map_default_alignment;
        $data['map_default_order_markers_by'] = $def_data->map_default_order_markers_by;
        $data['map_default_order_markers_choice'] = $def_data->map_default_order_markers_choice;
        $data['map_default_show_user_location'] = $def_data->map_default_show_user_location;
        $data['map_default_directions'] = $def_data->map_default_directions;
        $data['map_default_bicycle'] = $def_data->map_default_bicycle;
        $data['map_default_traffic'] = $def_data->map_default_traffic;
        $data['map_default_dbox'] = $def_data->map_default_dbox;
        $data['map_default_dbox_width'] = $def_data->map_default_dbox_width;
        $data['map_default_default_to'] = $def_data->map_default_default_to;
        $data['map_default_marker'] = $def_data->map_default_marker;
    ...
    if (isset($_GET['map_id'])) {
       ...
       if (stripslashes($res->map_height_type) == "%") { $wpgmza_map_height_type_percentage = "SELECTED"; } else { $wpgmza_map_height_type_px = "SELECTED"; }
        ...
        if ($res->listmarkers_advanced == "1") { $listmarkers_advanced_checked = "CHECKED"; } else { $listmarkers_advanced_checked = ""; }
...
function wpgmaps_tag_pro( $atts ) {
    ...
    if (isset($wpgmza_general_settings['wpgmza_settings_markerlist_category'])) { $hide_category_column = $wpgmza_general_settings['wpgmza_settings_markerlist_category']; }
    if (isset($wpgmza_general_settings['wpgmza_settings_markerlist_icon'])) { $hide_icon_column = $wpgmza_general_settings['wpgmza_settings_markerlist_icon']; }
    if (isset($wpgmza_general_settings['wpgmza_settings_markerlist_title'])) { $hide_title_column = $wpgmza_general_settings['wpgmza_settings_markerlist_title']; }
    if (isset($wpgmza_general_settings['wpgmza_settings_markerlist_address'])) { $hide_address_column = $wpgmza_general_settings['wpgmza_settings_markerlist_address']; }
    if (isset($wpgmza_general_settings['wpgmza_settings_markerlist_description'])) { $hide_description_column = $wpgmza_general_settings['wpgmza_settings_markerlist_description']; }
...
function wpgmaps_settings_page_sub($section) {
    ...
    if ($section == "mapsettings") {
        ...
        if (isset($wpgmza_settings['wpgmza_settings_markerlist_description'])) { $wpgmza_settings_markerlist_address = $wpgmza_settings['wpgmza_settings_markerlist_description']; } else { $wpgmza_settings_markerlist_address = ""; }
        if (isset($wpgmza_settings['wpgmza_settings_markerlist_address'])) { $wpgmza_settings_markerlist_description = $wpgmza_settings['wpgmza_settings_markerlist_address']; } else { $wpgmza_settings_markerlist_description = ""; }
